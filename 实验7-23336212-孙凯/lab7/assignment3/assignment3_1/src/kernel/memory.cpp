...
int MemoryManager::allocatePages(enum AddressPoolType type, const int count)
{
    ...
    int firstPhysicalPageAddress=0;
    ...
    for (int i = 0; i < count; ++i, vaddress += PAGE_SIZE)
    {
        ...
        if (physicalPageAddress)
        {
            ...
            if(i==0){
                firstPhysicalPageAddress=physicalPageAddress;
            }
    ...
    printf("Successfully allocated %d pages, virtual address: 0x%x physical address: 0x%x\n", count, virtualAddress, firstPhysicalPageAddress);
...
void MemoryManager::releasePages(enum AddressPoolType type, const int virtualAddress, const int count)
{
    ...
    printf("Successfully released %d pages, virtual address: 0x%x\n", count, virtualAddress);
}
